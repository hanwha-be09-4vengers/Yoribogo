...
) ENGINE=INNODB AUTO_INCREMENT=1 COMMENT='티어' CHARSET=UTF8;accbookdb
...
CREATE TABLE user (
    ...
    user_likes BIGINT NOT NULL DEFAULT 0,
    tier_id INT,
...
CREATE TABLE answer (
    ...
    writer_type VARCHAR(255) NOT NULL DEFAULT 'ENTERISE' CHECK(writer_type IN ('ENTERISE','ADMIN')),
...
CREATE TABLE public_data_recipe (
    ...
    public_data_menu_image TEXT NOT NULL,
    recipe_id BIGINT NOT NULL,
    FOREIGN KEY (recipe_id) REFERENCES recipe(recipe_id)
